    ...
    if (!show && signup) {
      ...
      appAxios
        ...
        .then((response) => {
          ...
          settext("کاربر ساخته شد، وارد شوید");
        })
        .catch((error) => {
          console.log(error);
          settext("کاربر ساخته نشد، دوباره تلاش کنید");
        });
    } else {
      //  login modal
      password === undefined
        ...
        : (settext2(""),
          appAxios
            ...
            .catch((error) => {
              console.error(error);
              settext2(" دوباره تلاش کنید");
            }));
    }
  }
  return (
    <span hidden={style.hidden}>
      <section className="w-screen h-screen bg-[#0000007a] flex items-center justify-center absolute top-0 left-0">
        <div className="w-screen h-screen md:w-[488px] md:h-auto  md:shadow-xl md:rounded-md bg-white text-divarFont text-[14px] leading-loose relative">
          ...
          <div className="" hidden={!signup}>
            ...
            <div className="p-4 select-none" hidden={!show}>
              <p className="my-[30px]  font-medium text-black text-[16px]">
                ...
                <p className="text-divarFontRed pr-4 inline">{text2}</p>
              </p>
              ...
              >
                <input
                  ...
                  name="password"
                  id="password"
                  className="w-full outline-none pr-2 text-black placeholder-stylel placeholder:text-end"
          ...
          <div className="p-4 select-none" hidden={signup}>
            <p className="my-[30px]  font-medium text-black text-[16px] inline-block">
              شمارهٔ موبایل و رمز عبور را وارد کنید
              <p className="inline pr-4 text-divarFontRed">{text}</p>
            </p>
            ...
            <form action="#" className={`  flex flex-col my-[14px] `} dir="ltr">
              ...
              >
                <input
                  ...
                  name="passwordSubmit"
                  id="passwordSubmit"
                  className="w-full outline-none pr-2 text-black placeholder-stylel placeholder:text-end placeholder:pr-4"
                  placeholder="رمز عبور"
                  onChange={(e: any) => {
                    setpassword(e.target.value);
                  }}
