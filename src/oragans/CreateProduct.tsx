...
import { rBool } from "../recoil/states.atom";
import { useRecoilState } from "recoil";
import CreatingProductLastPage from "./CreatingProductLastPage";
...
function CreateProduct(style: any) {
  ...
  const [bool] = useRecoilState(rBool);
  return (
    <div
    ...
    >
      <div hidden={bool}>
        ...
        <p className="text-sm mt-1 mb-4 text-divarFontHover">
          انتخاب دسته‌بندی
        </p>
